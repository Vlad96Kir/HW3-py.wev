...
# Категорії файлів та їх відповідні розширення
...
# Отримання списку файлів у папці та її підпапках
...
# Переміщення файлів в папки за категоріями
...
# Розархівування архівів у окрему папку
...
if __name__ == "__main__":
    folder_path = input("Введіть повний шлях до папки для сортування: ")
